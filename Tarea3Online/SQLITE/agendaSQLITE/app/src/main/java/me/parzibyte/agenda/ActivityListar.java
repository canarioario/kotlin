...
public class ActivityListar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] campos = {Utilerias.CAMPO_NOMBRE, Utilerias.CAMPO_TELEFONO, Utilerias.CAMPO_CORREO};
        ...
        do {
            ...
            String correo = cursor.getString(cursor.getColumnIndex(Utilerias.CAMPO_CORREO));
